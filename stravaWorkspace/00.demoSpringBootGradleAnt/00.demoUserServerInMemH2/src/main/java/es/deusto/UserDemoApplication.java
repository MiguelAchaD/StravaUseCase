...
public class UserDemoApplication {
    ...
    CommandLineRunner demo(UserRepository repository) {
      return (args) -> {
    	  ...
    	  User rebeca = new User ("Rebeca", "Cortazar", "rebeca.cortazar@deusto.es", DigestUtils.sha1Hex("123"));
    	  User roberto = new User ("Roberto", "Carballedo", "rcarba@deusto.es", DigestUtils.sha1Hex("123"));
